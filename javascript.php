                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-8 md-mb-50">
                            <div class="col-lg-6 pl-10 md-pr-15">
    							<div class="sec-title">
    								<div class="course-title">JAVASCRIPT Course Details</div>
    							</div>
    						</div>
                            <!-- Intro Info Tabs-->
                                        ...
                                        <div class="content white-bg pt-30">
                                            ...
                                            <div class="course-overview">
                                                <div class="inner-box">
                                                    ...
                                                    <p>JavaScript contains a standard library of objects, such as Array, Date, and Math, and a core set of language elements such as operators, control structures, and statements. Core JavaScript can be extended for a variety of purposes by supplementing it with additional objects. This means that in the browser, JavaScript can change the way the webpage (DOM) looks. And, likewise, Node.js JavaScript on the server can respond to custom requests from code written in the browser.</p>
